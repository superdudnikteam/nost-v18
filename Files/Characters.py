...
class Characters:
    ...
    def get_brawlers_id():
        ...
        with open('Files/csv_logic/characters.csv') as csv_file:
    ...
    def get_brawler_by_skin_id(self, skin_id):
        skins_file =  open('Files/csv_logic/skins.csv')
        ...
        for row in csv_reader:
            ...
            if line_count == 0 or line_count == 1:
                ...
                if line_count == skin_id + 3:
                    ...
                    sconf_file = open('Files/csv_logic/skin_confs.csv')
                    ...
                    for row in csv_reader:
                        if row[0] == conf:
                            ...
                            char_file = open('Files/csv_logic/characters.csv')
